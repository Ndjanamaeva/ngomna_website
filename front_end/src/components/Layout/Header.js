...
const Header = () => {
  ...
  const drawer = (
    <Box onClick={handleDrawerToggle} sx={{ textAlign: 'center' }}>
      ...
      <ul className="mobile-navigation">
        ...
        <li><a href="/#About_ngomna">About</a></li>
  ...
  return (
    <Box>
      <AppBar component="nav" sx={{ position: "fixed", bgcolor: 'rgba(255, 255, 255, 0.4)', flexShrink: 0, height: '100px', backdropFilter: 'blur(24px)', border: '1px solid', borderColor: 'divider', boxShadow: '0 0 1px rgba(85, 166, 246, 0.1), 1px 1.5px 2px -1px rgba(85, 166, 246, 0.15), 4px 4px 12px -2.5px rgba(85, 166, 246, 0.15)' }}>
        <Toolbar sx={{ display: "flex", justifyContent: "space-between" }}>
          ...
          <Box sx={{ display: { xs: "none", sm: "block" } }}>
            <ul className="navigation-menu">
              ...
              <li><a href="/#About_ngomna">About</a></li>
              <li><Link to="/contact">Contact</Link></li>
              <li><Link onClick={toggleLanguage}>{language === 'english' ? 'French' : 'English'}</Link></li>
              <Link to="/download">
